    ...
    return (
        <section className='container md:grid grid-cols-2 mx-auto py-10'>
            ...
            <div className='flex flex-col justify-center px-5 '>
                <h2 className='text-2xl md:text-5xl font-normal leading-loose mb-5'>Welcome come to <strong>EIM </strong> a popular and premium dates <strong>Inventory manager</strong> </h2>
                ...
                <div>
                    <Link to='/add-item' className='bg-color-primary hover:bg-gray-800 px-10 py-3 mt-3 text-white rounded-full inline-block font-bold'> Add New Item </Link>
