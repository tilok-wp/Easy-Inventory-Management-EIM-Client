    ...
    return (
        <header className='py-3 bg-white sticky top-0 z-10 shadow-lg shadow-slate-100'>
            <div className='container md:mx-auto lg:flex justify-between items-center relative z-10'>
                <Link className='z-10 relative' to='/'> <img className='ml-3' src={logo} alt="Logo" /> </Link>
                <nav className={`flex flex-col md:flex-row absolute text-center md:static w-full md:w-fit bg-blue-100 md:bg-transparent duration-500 ease-in ${toogle ? 'top-[65px]' : 'top-[-300px]'}`}>
