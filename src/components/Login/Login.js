    ...
    return (
        <div className='py-20 bg-slate-100 px-5'>
            ...
            <div className='md:w-1/3 mx-auto'>
                ...
                <p className='text-xl mt-10 mb-3'>Are you new user? <Link className='font-bold' to='/register'> Please register first </Link> </p>
                <p className='text-xl my-3'>Forgot your password? <button className='font-bold'> Reset please</button> </p>
